...
def get_fox_news_header():
  try:
    soup = get_soup("https://foxnews.com")
...
def get_cnn_header():
  try:
    soup = get_soup("https://www.cnn.com/data/ocs/section/index.html:homepage1-zone-1/views/zones/common/zone-manager.izl")
...
def get_cnbc_header():
  try:
    soup = get_soup("https://www.cnbc.com/")
...
def get_breitbart_header():
  try:
    soup = get_soup("https://breitbart.com")
...
def get_mother_jones_header():
  try:
    soup = get_soup("https://motherjones.com")
...
def get_nytimes_header():
  try:
    soup = get_soup("http://nytimes.com")
...
def get_daily_fx_header():
  try:
    soup = get_soup("http://dailyfx.com")
...
def get_ft_header():
  try:
    soup = get_soup("https://www.ft.com/")
...
def get_crypto_news_header():
  try:
    soup = get_soup("https://cryptonews.com/")
...
def get_pc_gamer_header():
  try:
    soup = get_soup("https://www.pcgamer.com/news/")
...
def get_kotaku_header():
  try:
    soup = get_soup("https://kotaku.com/culture/news")
    headlines = soup.find_all("h2")
